...
const driver = {
  ...
  dialect,
  engine: 'mongo@dbgate-plugin-mongo-v3',
  title: 'MongoDB v3',
  ...
  profilerFormatterFunction: 'formatProfilerEntry@dbgate-plugin-mongo-v3',
  profilerTimestampFunction: 'extractProfileTimestamp@dbgate-plugin-mongo-v3',
  profilerChartAggregateFunction: 'aggregateProfileChartEntry@dbgate-plugin-mongo-v3',
